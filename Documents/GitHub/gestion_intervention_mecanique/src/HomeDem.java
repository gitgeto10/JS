...
public class HomeDem extends javax.swing.JFrame {
    ...
    public HomeDem() {
        ...
        setLocationRelativeTo(null); 
         try {
            ...
            String sql = "SELECT * FROM interventions WHERE code_dem = '" + login.userCode + "'";
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Intervention", "Machine", "Problème", "Statut"
            }
        ));
        ...
        jButton2.setText("Nouvelle demande");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons8-ajouter-30.png"))); // NOI18N

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons8-déconnexion-arrondi-24.png"))); // NOI18N
